...
from obj_tr_constants	import d_limits, array_size, g_func, g_res_fn,h_function, R, Q
...
class compromized_state(object):
	...
	def get_update(self):
		...
		self.comp_PF.update(self.policy, self.c_prob, dt)
		self.uncomp_PF.update(self.policy, 1-self.c_prob, dt)
